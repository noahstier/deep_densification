...
class ResnetBlockFC(nn.Module):
    ...
    def __init__(self, size_in, size_out=None, size_h=None):
        ...
        self.norm_0 = torch.nn.GroupNorm(4, size_in)
        self.norm_1 = torch.nn.GroupNorm(4, size_h)
        # self.norm_0 = torch.nn.BatchNorm1d(size_in)
        # self.norm_1 = torch.nn.BatchNorm1d(size_h)
    ...
    def forward(self, x):
        net = x
        net = self.norm_0(net.transpose(1, 2)).transpose(1, 2)
        net = self.fc_0(self.actvn(net))
        net = self.norm_1(net.transpose(1, 2)).transpose(1, 2)
...
class ResnetBlockConv1dNoBn(nn.Module):
...
class ResnetBlockConv1d(nn.Module):
    ...
    def __init__(self, size_in, size_h=None, size_out=None, bnm=.1):
        ...
        self.bn_0 = torch.nn.GroupNorm(4, size_in)
        self.bn_1 = torch.nn.GroupNorm(4, size_h)
