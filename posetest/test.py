...
verts, faces, _, _, = skimage.measure.marching_cubes_lewiner(pred_vol, level=0)
...
o3d.visualization.draw_geometries([query_pcd, axes, cam_mesh, fuze_mesh, mesh])
# o3d.visualization.draw_geometries([reproj_pcd, axes, cam_mesh, fuze_mesh, mesh])
